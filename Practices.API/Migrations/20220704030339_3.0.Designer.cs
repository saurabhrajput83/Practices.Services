...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Practices.API.DAL.Entities.LineItem", b =>
                {
            ...
            modelBuilder.Entity("Practices.API.DAL.Entities.ShoppingCart", b =>
                {
                    b.Property<int>("ShoppingCartId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("practice_t_ShoppingCart");
                });

            modelBuilder.Entity("Practices.API.DAL.Entities.LineItem", b =>
                {
                    b.HasOne("Practices.API.DAL.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Practices.API.DAL.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany()
